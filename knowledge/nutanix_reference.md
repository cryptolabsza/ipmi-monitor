...
Nutanix appliances generate standard Dell PowerEdge events. See the [Dell PowerEdge Reference](dell_poweredge_reference.md) for complete event documentation.
...
- [Dell PowerEdge Reference](dell_poweredge_reference.md) - Base platform events
